 ...
 * Header title.
 */
define('PDF_HEADER_TITLE', 'Laporan Pelanggan Yang Datang ke Bengkel');
define('PDF_HEADER_TITLE_NOTA', 'NOTA PEMBAYARAN');

/**
 * Header description string.
 */
define('PDF_HEADER_STRING', "Bengkel Martono");
